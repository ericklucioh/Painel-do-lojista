      ...
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col justify-center gap-10">
        <div className="max-w-3xl space-y-5">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
            Base inicial do desafio técnico, organizada para evoluir para CRUD,
            estoque e PDV.
          </h1>
          <p className="max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
            A estrutura já está separada por domínio e com rotas em português,
            como o enunciado pede. A próxima etapa é plugar autenticação, API e
            os formulários.
          </p>
        </div>
